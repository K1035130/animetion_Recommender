...
库占用 **636 MB**（`pg_database_size()`；Neon 控制台口径更高，见第 5 节）。
`plot_chunk` **90,126 条**（萌娘 20,127 + dump 角色 69,999）· 覆盖系列根 6,131 个 ·
**覆盖作品 79.3% · 热度加权 97.3%**。
`alias` **235,020 行**（subject 38,378 + character 196,642）。
