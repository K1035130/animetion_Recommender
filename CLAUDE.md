...
**语料层已完工并入库。下一步：阶段 03（角色语料）→ 阶段 05（检索层）**，
顺序与理由见下方「六阶段计划」，检索层的完整设计见 **G 节**。
...
| **03** | **灌 dump 角色简介** | ⬜ **下一步** | 66,871 条 · 均 139 字 / ≈15 分 / **¥0.46 零抓取** |
...
| **③ 跨作品找线索**（新增） | `plot_chunk` | 不限定 | ≈ 77 ms | chunk → 聚合成作品 |
