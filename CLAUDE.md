...
测试 313 → **329**。**完整记录见第四部分「个人中心页」那一节**，三条先知道的：
...
**完整记录见第四部分「声优回答升级」那一节**，这里只留三条最该先知道的：
...
✅ 账号系统                注册 · 登录 · 评分持久化 · 问答配额，见第四部分「账号系统」
✅ 用户名取代邮箱          根因是「没有发信能力」，见第四部分那一节
✅ 测试 247 → 297 项全绿
```
