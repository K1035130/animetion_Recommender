...
| anime_profile（1024 float4，**11,453 条**实测） | 47 MB |
| 元数据 + BM25 索引 | 20 MB |
...
年代分布：1989 及以前 492 / 1990s 862 / 2000–2005 1,189 / 2006–2010 1,491 / 2011+ 7,112（另有 194 部靠 infobox 补出年份，多为国产老动画）。
...
- [x] ~~真实候选集规模~~ → **11,453 部**（全年份），profile 向量 47 MB，总预算 319 MB / 余量 36%
...
现有预算已占 319 MB / 500 MB，**余量只有 181 MB**。两者叠加必然超限，而 Neon 免费层超限是**直接挂起项目**，不是计费。
